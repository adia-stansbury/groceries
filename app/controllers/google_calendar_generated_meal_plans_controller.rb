...
class GoogleCalendarGeneratedMealPlansController < ApplicationController
  def new
    ...
    adia_recipe_names = GoogleCalendarApi.get_recipe_names_from_calendar(ENV['ADIA_CALENDAR_ID'], params['start_date'].to_time.iso8601)
    mick_recipe_names = GoogleCalendarApi.get_recipe_names_from_calendar(ENV['MICK_CALENDAR_ID'], params['start_date'].to_time.iso8601)
